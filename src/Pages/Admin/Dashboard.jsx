...
function Dashboard() {
  ...
  return (
    <div className="flex">
      ...
      <div className="flex-1 p-6 bg-gray-100 m-6">
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
      ...
      <div className="bg-white p-4 rounded-lg shadow">
        ...
        <p className="text-gray-600">8,900</p>
      </div>
...
<div style={{height:'aut',width:'auto'}} className="max-w-sm w-full bg-white rounded-lg shadow dark:bg-gray-800 p-4 md:p-6">
...
<div class="max-w-sm w-full bg-white rounded-lg shadow dark:bg-gray-800 p-4 md:p-6">
  ...
  <div class="grid grid-cols-1 items-center border-gray-200 border-t dark:border-gray-700 justify-between">
    ...
    <div className="mt-6">
      ...
      <div className="bg-white p-4 rounded-lg shadow">
        <p className="text-gray-600">You have 5 new sales today.</p>
      </div>
    </div>
