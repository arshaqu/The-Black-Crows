    ...
    return (
        ...
        >
            ...
            <div style={{backgroundColor:'rgba(255, 255, 255, 0.5)' , width:'450px' ,height:'auto'}} className="relative z-10 shadow-md rounded-lg text-left w-105 p-8">
                ...
                <div className="mt-4">
                    <label style={{fontWeight:'semi-bold'}} className="block  text-gray-800 montserrat">Email</label>
                    <input
                        type="email"
                        placeholder="Enter Your Email"
                        className="border w-full h-11 px-4 mt-2 mb-4 rounded-md focus:outline-none focus:ring-2 focus:ring-black-400 montserrat"
                        value={email}
                    ...
                    <input
                        ...
                        className="border w-full h-11 px-4  mb-2 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-400 montserrat"
                        value={password}
                    ...
                    <div className="mt-2">
                        ...
                        >
                            ...
                            <div className='mt-5'>
                            <a className='text-blue-900'  href="/register">New to the Account</a>
                            </div>
                    </div>
                </div>
            </div>
